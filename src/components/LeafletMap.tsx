...
const LeafletMap: React.FC<LeafletMapProps> = ({ showHeatmap = false, isMounted = true, containerRef }) => {
  ...
  useEffect(() => {
    ...
    // Leaflet doesn't have a built-in setStyle method, so we'd need a different approach
  }, [theme]);
  ...
  return (
    <MapContainer 
      ...
      zoom={mapZoom} 
      style={mapStyle} 
      ref={map as React.RefObject<L.Map>} 
